...
function Footer() {
    ...
    return <footer className="py-10 bg-green-200 dark:bg-[#0F1522] px-4 sm:px-6 lg:px-8 font-inter relative overflow-hidden ">
        <div className="max-w-7xl mx-auto flex flex-col items-center relative z-10">
            ...
            <div className="py-6 text-sm text-center dark:text-gray-600">© {new Date().getFullYear()} Quickmart. All rights reserved by LS Coder.</div>
        </div>
    </footer>;
}
