...
export default function Login() {
  ...
  const [callbackUrl, setCallbackUrl] = useState('/products');

  // Client-side only: URL query reading
  useEffect(() => {
    ...
    <div className="relative w-full flex items-center justify-center font-sans overflow-hidden">
      <div className="relative w-full max-w-sm p-6 space-y-6 bg-white dark:bg-black rounded-lg border border-zinc-200 dark:border-zinc-800 shadow-lg dark:shadow-zinc-900/50">
        ...
        <div className="w-full">
          <button onClick={() => signIn("google", { callbackUrl })} className="flex gap-1.5 cursor-pointer items-center justify-center h-9 w-full px-3 py-6 rounded-md border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-black hover:bg-zinc-50 dark:hover:bg-zinc-900 hover:text-zinc-900 dark:hover:text-zinc-50 transition-colors focus-visible:outline-none focus-visible:ring-1 font-semibold focus-visible:ring-zinc-950 dark:focus-visible:ring-zinc-300">
